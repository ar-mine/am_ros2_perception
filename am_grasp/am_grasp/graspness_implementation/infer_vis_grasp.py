...
parser.add_argument('--dataset_root', default='/media/automan/6E94666294662CB1/A_Content/GraspNet')
parser.add_argument('--checkpoint_path', default='/home/automan/ROS2/cobot_ws/src/am_ros2_perception/am_grasp/am_grasp/graspness_implementation/ckpts/minkuresunet_realsense.tar')
parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='/home/automan/ROS2/cobot_ws/src/am_ros2_perception/am_grasp/am_grasp/graspness_implementation/logs/')
